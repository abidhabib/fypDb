...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1539346141ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=subjects">`Final`.`subjects`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=students">`Final`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=Sessions">`Final`.`Sessions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=Semesters">`Final`.`Semesters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=periods">`Final`.`periods`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=lecturers">`Final`.`lecturers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=deptartments">`Final`.`deptartments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=attendance">`Final`.`attendance`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Final&table=Admins">`Final`.`Admins`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="32223564336b6923376173267b58283f">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="Final" targettable="Admins">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `Admins`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="attendance">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `attendance`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="deptartments">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `deptartments`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="lecturers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `lecturers`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="periods">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `periods`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="periods">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `periods`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="Semesters">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `Semesters`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="Sessions">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `Sessions`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="students">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `students`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="Final" targettable="subjects">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `subjects`</span>
                        </div>
