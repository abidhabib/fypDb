...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=549425693ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=attsystem&table=reports">`attsystem`.`reports`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=attsystem&table=attendance">`attsystem`.`attendance`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=attsystem&table=admininfo">`attsystem`.`admininfo`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=attendance_system&table=users">`attendance_system`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=admin">`final_project`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=semester_student">`final_project`.`semester_student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=class_subjects">`final_project`.`class_subjects`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=students">`final_project`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=teachers">`final_project`.`teachers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=programs">`final_project`.`programs`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="732a36796850314f7356244b733f2861">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="final_project" targettable="admin">
...
CREATE TABLE `attendance` (
  ...
  `date_time` date NOT NULL
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="attendance_system" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="attendance_system" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="attsystem" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
...
CREATE TABLE `admininfo` (
  ...
  `type` varchar(20) NOT NULL
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="attsystem" targettable="admininfo">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admininfo`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="attsystem" targettable="attendance">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `attendance`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="attsystem" targettable="reports">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
